...
function ListItemCat(props) {
  ...
  return (
    <div className="container">
            ...
            <div key={item.id} className="col-3 align-self-start mb-4">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text text-start fw-bold text-danger">
                    {item.price} $
                  </p>
                  <div className="text-start mb-2 d-flex align-items-center">
                    ...
                    <span className="ms-2">
                      {item.rating.rate}
                      <GrStar />/{item.rating.count} <IoIosPeople />
                    </span>
                    <span className="ms-4">
                      Like
                      <BsHeart
                        className="ms-2"
                        style={{ color: "#f8121d", cursor: "pointer" }}
                      />
                    </span>
                  </div>
                  <a onClick={() => getItem(item)} className="btn btn-primary">
                    Get View
                  </a>
                </div>
              </div>
      ...
      <div
        className={
          (itemDetail?.id ? "d-block bg-secondary-subtle" : "") +
          " modal fade show"
        }
        id="exampleModalXl"
              ...
              <div className="card" style={{ width: "18rem" }}>
                ...
                <div className="card-body">
                  ...
                  <div className="text-start mb-2 d-flex align-items-center">
                    ...
                    <span className="ms-2">
                      {itemDetail?.rating?.rate}
                      <GrStar />/{itemDetail?.rating?.count} <IoIosPeople />
                    </span>
                    <span className="ms-4">
                      Like
                      <BsHeart
